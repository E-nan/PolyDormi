...
{
    public partial class Halla_Build : Form
    {
        ...
        Halla main = null;
        public Halla_Build(Halla main)
        {
            this.main = main;
            InitializeComponent();
        }

        private void Build_New_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            mConnection.Open();
            MySqlCommand cmd = new MySqlCommand("INSERT INTO build_halla values('" + floor + "','"              //층

...
{
    public partial class Baekdu_S_Update : Form
    {
        ...
        Baekdu main = null;
        public Baekdu_S_Update(Baekdu main)
        {
            this.main = main;
            InitializeComponent();
        }

        private void Baekdu_S_Update_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("UPDATE baekdu_stu SET room='" + new_Room.Text +
